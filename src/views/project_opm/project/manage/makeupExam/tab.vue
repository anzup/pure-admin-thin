...
<script lang="ts" setup>
  ...
  import FlightCmp from './index.vue'
  import TheoryCmp from './theory.vue'
  import { useI18n } from 'vue-i18n'
  const { t } = useI18n()
  const tabList = shallowRef([
    { id: 'flight', name: t('text.simulator_training'), code: '', cmp: FlightCmp },
    { id: 'theory', name: t('text.ground_theory_test'), code: '', cmp: TheoryCmp },
  ])
