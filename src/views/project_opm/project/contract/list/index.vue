...
<script lang="ts" setup>
  ...
  import CurrentCmp from './current.vue'
  import HistoryCmp from './history.vue'
  import { useI18n } from 'vue-i18n'
  const { t } = useI18n()
  const tabList = shallowRef([
    { id: 'current', name: '当前合同', code: '', cmp: CurrentCmp },
    { id: 'history', name: t('message.historicalContract'), code: '', cmp: HistoryCmp },
  ])
