...
<script>
   ...
   */
  import videoPlayer from './video-player.vue' // 导入视频播放组件
  import audioPlayer from './audio-player.vue' // 导入音频播放组件
  import pdfOnline from './pdf-online.vue' // 导入pdf预览组件
  import imgOnline from './img-online.vue' // 导入img预览组件
  import officeOnline from './office-online.vue'
  export default {
    data() {
      return {
    ...
    components: { videoPlayer, audioPlayer, pdfOnline, imgOnline, officeOnline },
  }
</script>
