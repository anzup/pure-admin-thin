...
<script lang="ts" setup>
  import auditCmp from './components/auditCmp.vue'
  import ruleCmp from './components/ruleCmp.vue'
  ...
  const tabList = shallowRef([
    ...
    {
      id: 'audit',
      name: t('router.qualificationAudit'),
      cmp: auditCmp,
      menuName: 'QUALIFICATIONS_REVIEW_REQUEST',
    },
    // 运规审核
    {
      id: 'rules',
      name: t('router.operationRuleAudit'),
      cmp: ruleCmp,
      menuName: 'QUALIFICATIONS_REVIEW_PROVIDE',
    },
  ])
