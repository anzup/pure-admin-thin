            ...
            <ul class="serialNumberBox">
              ...
              >
                <el-badge :is-dot="kItem.marked">
                  <el-button
                    v-if="kItem.type == 'MULTIPLE_CHOICES' || kItem.type == 'INDEFINITE_CHOICES'"
                    class="share-button share"
                    :class="{ 'is-red': kItem.questionScore != kItem.score }"
                    :type="kItem.answers.length !== 0 ? 'primary' : 'info'"
                    >{{ kIndex + 1 }}</el-button
                  >
                  <el-button
                    v-else
                    class="share-button share"
                    :class="{ 'is-red': kItem.questionScore != kItem.score }"
                    :type="kItem.answers !== null && kItem.answers !== '' ? 'primary' : 'info'"
                    >{{ kIndex + 1 }}</el-button
                  >
                </el-badge>
              </li>
      ...
      <el-col :span="16">
        <div class="examPaperViewRight" :style="{ height }">
          <div v-if="questions.length !== 0">
            ...
            <div class="num">
              <span>
                <el-divider direction="vertical" />{{ formatScore(questionInfo.index + 1) }}</span
              >
              <span
