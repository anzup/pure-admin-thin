  ...
  <div>
    ...
    <div class="main-table-content">
      <template v-for="plane in tabList" :key="plane.id">
        <component v-if="plane.id === currentTab.id" :is="currentTab.cmp" :type="currentTab.id" />
      </template>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  import Cmp from './components/courseware.vue'
  ...
  const tabList = shallowRef([
    { id: 'PUBLIC', name: t('table.openCourseware'), menuName: 'COURSEWARE_PUBLIC', cmp: Cmp },
    {
      id: 'THIRD_PARTY',
    ...
    { id: 'SELF', name: t('table.ownCourseware'), menuName: 'COURSEWARE_SELF', cmp: Cmp },
  ])
