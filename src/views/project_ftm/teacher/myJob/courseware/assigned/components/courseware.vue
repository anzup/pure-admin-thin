...
<!--        &lt;!&ndash;TODO 按钮权限&ndash;&gt;-->
<!--        &lt;!&ndash;v-permission="menuName + ':TYPE_CHANGES'"&ndash;&gt;-->
<!--        <el-button-->
...
<!--        >-->
<!--        &lt;!&ndash;v-permission="menuName + ':SUBMIT_REVIEW'"&ndash;&gt;-->
<!--        <el-button-->
<!--          :disabled="records.length == 0"-->
<!--          type="primary"-->
<!--          size="mini"-->
...
<!--        >-->
<!--        &lt;!&ndash;v-permission="menuName + ':COURSEWARE_ASSIGNMENT'"&ndash;&gt;-->
<!--        <el-button-->
<!--          :disabled="records.length == 0"-->
<!--          type="primary"-->
<!--          size="mini"-->
...
<!--        >-->
<!--        &lt;!&ndash;v-permission="menuName + ':APPLY_REVIEW'"&ndash;&gt;-->
<!--        <el-button-->
<!--          :disabled="records.length == 0"-->
<!--          type="primary"-->
<!--          size="mini"-->
...
<!--        >-->
<!--        &lt;!&ndash;v-permission="menuName + ':UPLOAD'"&ndash;&gt;-->
...
<!--              }-->
<!--            : null,-->
<!--          { title: this.$t('table.tableEdit'), width: 330, slots: { default: 'edit' } },-->
<!--        ].filter((item) => item)-->
<!--        return colmns-->
<!--      },-->
<!--    },-->
...
<!--        await this.$store.dispatch('UPDATE_SYSTEM')-->
