...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      upload() {
        this.routerGo(`list/add?type=${this.form.type}`)
      },
      ...
      details(id) {
        this.routerGo(`list/details?id=${id}`)
      },
      modify(id) {
        this.routerGo(`list/info?type=${this.form.type}&id=${id}`)
      },
      ...
      coursewareAssignment() {
        // 课件指派 教务员指派教员
        this.routerGo(`list/teacher?ids=${this.records.join(',')}`)
      },
      // 类型变更
