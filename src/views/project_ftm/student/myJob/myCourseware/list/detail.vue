    ...
    <div class="header warp-content-table">
      <el-row style="width: 100%">
        ...
        <el-col
          ...
          :offset="1"
          class="review-mtop"
          :class="{ 'review-fix': windowWidth < 769 }"
        >
          ...
          <div class="review-box" v-if="coursewaresInfo.fileType == 'SCORM'">
          ...
          <div class="review-tool" v-if="coursewaresInfo.fileType != 'MP4'">
              ...
              <div>
                ...
                >
                  ...
                  <div class="commentInfo">
                    ...
                    <div class="time">{{ iItem.createdDate }}</div>
                    <div class="info">
                      ...
                      <div class="icons">
                        ...
                        <img
                          :src="images.shanchu"
                          class="huifu"
                          v-show="iItem.creator.id == userId"
...
<script>
  ...
  import ImageDianzan from '/@/assets/ftm/dianzan.png'
  import ImageDianzan1 from '/@/assets/ftm/dianzan1.png'
  import ImageHuifu from '/@/assets/ftm/huifu.png'
  import ImageShanchu from '/@/assets/ftm/shanchu.png'
  ...
  export default {
    data() {
      ...
      return {
        ...
        iconSrc: '',
        images: {
          dianzan: ImageDianzan,
          dianzan1: ImageDianzan1,
          huifu: ImageHuifu,
          shanchu: ImageShanchu,
        },
      }
    },
    computed: {
          ...
          if (res.status == 200) {
            ...
            if (
              ...
              this.officeUrl =
                ...
                encodeURIComponent(`${url}/open/${res.data.fileUuid}/inline`)
            } else if (this.coursewaresInfo.fileType == 'SCORM') {
              window.API && window.API.reset()
              window.API_1484_11 && window.API_1484_11.reset()
              this.officeUrl = `${import.meta.env.VITE_BASE_API_PUB}/open/${res.data.fileUuid}/${
                res.data.playFilePath
              }`
            }
          }
        })
...
<style scoped lang="scss">
  @import '/@/views/project_ftm/student/styles/variables.scss';
