...
export const getSchedulerClass = function (params?: { startDate: string; endDate: string }) {
  return request({
...
export const getSchedules = function (params: GetScheduler): AxiosPromise<DefaultPagingData> {
  return request({
    url: url + `/schedules`,
    method: 'get',
    params,
...
export interface PutSchedulers extends Omit<PostSchedulers, 'scheduleSyllabusItemId'> {
  id: number
}
 ...
 * @function 替换设施
 */
export const putSchedulerFacility = function (id: number, oldId: number, newId: number) {
  return request({
 ...
 * @function 替换教员
 */
export const putSchedulerTeacher = function (id: number, oldId: number, newId: number) {
  return request({
...
export const getInternalTrainingSelfstudies = function (params: InternalSelfStudis) {
...
export interface PostInternalSelf extends Omit<InternalSelfStudis, keyof PageBase | 'users'> {
  userIds: number[]
...
export const putInternalTrainingSelfStudies = (params: PostInternalSelf & { id: number }) => {
  const { id, ...data } = params
  return request({
    url: url + '/internalTrainingSelfstudies/' + id,
    method: 'put',
