...
export const getCoursewares = function (
  params: GetCoursewares
...
export const getCoursewaresTeachers = function (
  id: number
...
export interface GetCoursewareReadRecords
  extends PageBase,
    Partial<
      Record<
        "courseNumber" | "coursewareId" | "createdBy" | "userId" | "versionId",
        number
      >
    > {
