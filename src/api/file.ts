...
export interface FolderDetail extends Omit<Folder, 'folderListVOS'>, DefaultAllListItem {
  accessControls: AccessControls[]
  folders: FolderItem[]
  resources: Resources[]
  uuid: string
...
export interface PostFolder extends PartialOptional<Omit<FolderItem, 'path' | 'uuid'>, 'id'> {
  parentUuid: string
}
