...
export const getAuthConfig = (params) =>
  request({
    url: url + `/roles/${params.id}/authConfigs`,
    method: 'get',
    params,
  })
/**
 * 设置职位权限配置
 */
export const setAuthConfig = (data) =>
  request({
    url: url + `/roles/${data.id}/authConfigs`,
    method: 'post',
    data,
  })
 ...
 * 获取职员权限
 */
export const getEmployeeConfig = (params) =>
  request({
    url: url + `/employees/${params.id}/authConfigs`,
    method: 'get',
    params,
  })
/**
 * 设置职员权限
 */
export const setEmployeeConfig = (data) =>
  request({
    url: url + `/employees/${data.id}/authConfigs`,
    method: 'post',
    data,
  })
/**
 * 待审核职员列表
 */
export const getEmployeeRegistries = (params) =>
  request({
    url: url + `/employee/registries`,
    method: 'get',
    params,
  })
/**
 * 待审核职员审核
 */
export const postEmployeeRegistriesApprove = (data) =>
  request({
    url: url + `/employee/registries/approve`,
    method: 'post',
    data,
  })
