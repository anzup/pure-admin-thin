...
export const getSchedulesClass = function (
    classId: number,
    isTeacher: boolean
) {
    return request({
 ...
 * }
 */
export const putSchedulesTime = function (data: {
    scheduleIds: number[];
    periods: number[];
}) {
    return request({
...
export const getScheduleSearchKey = function (params: {
    ...
    return request<DefaultReturn<Scheduler.People[]>>({
...
export const putOccupied = function (
    ...
    return request({
        url:
            url +
            `/schedules/occupied/${oldOccupiedNumber}/${num}/${newOccupiedNumber}`,
        method: "put"
    });
};
// 占位导出
...
export const getDelaySchedulesStep = function (params: {
    ...
    return request({
        url:
            url +
            `/schedules/delay/${startScheduleId}/${endScheduleId}/${step}`,
        method: "get"
    });
};
// 拆分学员
