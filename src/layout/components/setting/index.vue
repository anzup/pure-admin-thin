<script lang="ts" setup>
  ...
  let themeColors = ref<Array<themeColorsType>>([
    // 道奇蓝（默认）
    { color: '#215ebe', themeColor: 'default' },
    // 亮白色
    { color: '#ffffff', themeColor: 'light' },
    // 猩红色
    { color: '#215ebe', themeColor: 'dusk' },
    // 橙红色
  ...
  let layoutTheme =
    ref(storageLocal.getItem('-layout')) ||
    ref({
...
<template>
  <panel>
    ...
    <ul v-show="!dataTheme" class="theme-color">
      ...
      >
        <el-icon :color="getThemeColor(item.themeColor)" :size="17" style="margin: 0.1em 0.1em 0 0">
    ...
    <el-divider />
    <el-button style="width: 90%; margin: 24px 15px" type="danger" @click="onReset">
      <IconifyIconOffline
        height="15"
