 ...
 * @LastEditTime: 2022-05-27 11:24:45
 * @FilePath: \crew-web\src\utils\request\index.ts
 * @Description:
 *
  ...
  public request<T = any, P = HttpCustomConfig>(
    ...
    return new Promise((resolve, reject) => {
      ...
      if (
        ...
        Object.keys(axiosConfig.params || {}).length
      ) {
        const obj = {};
        for (let key in axiosConfig.params) {
